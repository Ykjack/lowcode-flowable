package com.lowcode.flowable.common.config;
        ...
        if (bean instanceof AbstractSecurityInterceptor) {
            ...
            manager.getDecisionVoters().add(new AccessDecisionVoter<Object>() {
                ...
                public int vote(Authentication authentication, Object object, Collection<ConfigAttribute> attributes) {
                    return null == authentication || !(authentication.getPrincipal() instanceof User) ? AccessDecisionVoter.ACCESS_DENIED : AccessDecisionVoter.ACCESS_GRANTED;
                }
            });
        }
        return bean;
